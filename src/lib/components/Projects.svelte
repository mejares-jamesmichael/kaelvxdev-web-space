...
<section id="projects" class="py-20 pointer-events-auto">
  <div class="mb-12">
  ...
  <div
    class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-[minmax(0,1fr)]"
  >
    <ProjectCard
    ...
    <ProjectCard
      ...
      stats={[
        ...
        {
          label: "Shell",
          value: "PowerShell + Nu Shell",
          color: "text-yellow-400",
        },
        {
          label: "Terminals",
          value: "Windows Terminal + Tmux",
          color: "text-purple-400",
        },
      ]}
    />
