export const config = {
  ...
  certifications: [
    {
      ...
      certificateUrl:
        "https://drive.google.com/file/d/155U3JbJb_RHIlgCkQqA8Xi-qkZjPW6Lo/view?usp=sharing",
    },
    {
      name: "Cisco Networking Academy",
      field: "Introduction to Cybersecurity",
      issuer: "Cisco",
      issued: "Aug 2026",
      expires: null,
      verifyUrl:
  ...
  noteCategories: [
    ...
    { id: "feedback", label: "Feedback", color: "text-blue-400" },
    { id: "question", label: "Question", color: "text-yellow-400" },
    { id: "compliment", label: "Compliment", color: "text-green-400" },
    { id: "thought", label: "Thought", color: "text-purple-400" },
  ],
};
